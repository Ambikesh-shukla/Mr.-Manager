...
export async function loadAll() {
  ...
  const files = ['guilds', 'panels', 'panel', 'tickets', 'cooldowns', 'plans', 'reviews', 'orders', 'suggestions', 'autoresponses', 'faqs', 'commandlocks', 'welcomes', 'linkconfigs', 'serverprovision'];
